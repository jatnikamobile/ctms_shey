 ...
 * @property int $status_bmi
 * @property int $status_tekanan_darah
 */
class Pemeriksaan extends \yii\db\ActiveRecord
{
    use ListableTrait;

    const PEMERIKSAAN_FISIK = 1;
    const PEMERIKSAAN_LABORATORIUM = 2;
    const PEMERIKSAAN_RADIOLOGI = 3;
    const PEMERIKSAAN_SPIROMETRI = 4;
    const PEMERIKSAAN_AUDIOMETRI = 5;
    const PEMERIKSAAN_EKG = 6;
    const PEMERIKSAAN_TREADMIL = 7;
    const PEMERIKSAAN_USG = 8;

    const BMI = 1;
    const TEKANAN_DARAH = 1;
    const PEMERIKSA_TTD = 3;
    ...
    {
        return $this->hasMany(PaketPemeriksaan::class,['id_pemeriksaan' => 'id']);
    }
    ...
    public static function getListIndukPemeriksaan()
    {
