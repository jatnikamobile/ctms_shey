...
(9, 1112, 'Mediantara', NULL),
(10, 1113, 'RSAU ESNAWAN ANTARIKSA', NULL),
(11, 1114, 'PT. DAHANA', NULL),
(12, 1115, 'SALIM', NULL);
...
(9, 10, 2, 'KELUHAN UTAMA : SERING PUSING, RIWAYAT KESEHATAN DULU : ANEMIA, KEBIASAAN : OLAHRAGA, KACAMATA : Pakai, Kelopak Mata : Hordeolum, ', 'CEK SECARA BERKALA LABORATORIUM  SEPERTI PEMERIKSAAN CHOLESSTEROL, PERIKSA'),
...
(5, 4, 3, '123123123', 'Mu\'in ', 'Jalan turuluk nomor 3 rt 6 rw 9', 'Bumi', '2019-07-31', NULL, 'Laki-Laki', 'AB', '080000001', 'belum kawin', '1', '', '7'),
(6, 8, 5, '1546112156771432', 'Test Pendaftaran', 'Jl. Bangunrejo Jakarta', 'Bandung', '2001-10-10', NULL, 'Laki-Laki', 'O', '081809072939', 'kawin', '1', '', '3'),
(7, 4, 4, '08465921513', 'bdul', 'kp. baru', 'bandung', '1992-12-31', NULL, 'Laki-Laki', 'O', '08152646845', 'belum kawin', '1', '1', '3'),
(9, 9, 4, '1044312407078100', 'Sunardi Prawirotomo', 'Jl. Terusan Kali Urang, Kebon Bibit Jakarta Pusat', 'Bandung', '2009-06-23', NULL, 'Laki-Laki', 'B', '082121988768', 'belum kawin', '1', '3', '3'),
(10, 10, 6, '197712072007', 'DEWI SAKTI LESTARI', 'JL. MERCURE BEKASI', 'JAKARTA', '1988-07-04', NULL, 'Perempuan', 'O', '879067890', 'kawin', '1', '1', '4'),
(11, 12, NULL, '19738987645', 'SALIM ASSAKRON', 'JL. CIDAHU SELATAN KAMBING NERACA', 'BOGOR', '1974-07-23', NULL, 'Laki-Laki', 'A', '', 'kawin', '1', '1', '3');
...
(30, 2, 'Imunoserologi', NULL, NULL),
(31, NULL, 'Laboratorium Paket D', NULL, NULL),
(32, 31, 'Hematologi', NULL, NULL),
(33, 31, 'Urinalisa', NULL, NULL),
(34, NULL, 'FIsik Paket D', NULL, NULL),
(35, 34, 'BMI/GIZI', 1, NULL),
(36, 34, 'Tekanan Darah', 1, NULL);
...
(64, 2, NULL, 'Hasil Pemeriksaan', NULL, 1, NULL, NULL),
...
(181, 2, NULL, 'Nama Pemeriksa', NULL, 6, NULL, NULL),
...
(4, 4, '06180002', 2, 1, 5, '2019-08-01', '123123123', 'Mu\'in ', 'Jalan turuluk nomor 3 rt 6 rw 9', 'Bumi', '2019-07-31', 'Laki-Laki', 'AB', '080000001', 'belum kawin', 9, 3, 1, 1, 7),
(6, 6, '06180003', 3, 1, 7, '2019-07-24', '08465921513', 'LIAN DONOVAN', 'kp. baru', 'bandung', '1992-12-31', 'Laki-Laki', 'O', '08152646845', 'belum kawin', 10, 4, 1, 1, 3),
(8, 3, '6180003', 3, 3, 8, '2019-07-24', '08546885475', 'BAMBANG PAMUNGKAS', 'gak tau tuh', 'rahasia', '2017-01-30', 'Laki-Laki', 'O', '0854679864', 'dibawahumur', 10, 5, 6, 3, 6),
(9, 4, '11120001', 1, 1, 9, '2019-07-29', '1044312407078100', 'Sunardi Prawirotomo', 'Jl. Terusan Kali Urang, Kebon Bibit Jakarta Pusat', 'Bandung', '2009-06-23', 'Laki-Laki', 'B', '082121988768', 'belum kawin', 9, 4, 1, 3, 3),
(10, 5, '11130001', 1, 1, 10, '2019-07-26', '197712072007', 'DEWI SAKTI LESTARI', 'JL. MERCURE BEKASI', 'JAKARTA', '1988-07-04', 'Perempuan', 'O', '879067890', 'kawin', 10, 6, 1, 1, 4),
(11, 6, '11150001', 1, 5, 11, '2019-07-27', '19738987645', 'SALIM ASSAKRON', 'JL. CIDAHU SELATAN KAMBING NERACA', 'BOGOR', '1974-07-23', 'Laki-Laki', 'A', '', 'kawin', 12, NULL, 1, 1, 3);
...
(7, 'testdokter', '$2y$13$qaiExNKQzELHWJHfVd/WQughTupUQbTyKERzpmhFoQf8Rl8j0WXQ2', NULL, 3, 'test@gmail.com', NULL, 7),
(8, 'drt', '$2y$13$.kxIVRnCagAKq8cvO4bmquOkr4LcHKCev.lzjJ8pcdrYYGQshRgZK', NULL, 3, 'DRT@GMAIL.COM', NULL, 8),
(10, 'mediantara', '$2y$13$KIeWGR9RXBGjKfwGzDzlPOAjhbaozWr34w4OBfXrb6aop94nWKzBS', NULL, 2, NULL, 9, NULL),
(11, 'rsauesnawan', '$2y$13$cdxljipf.cXNjlYcAmGHLOqw4fYncNL.lV9zIL2Jm2w1FQNEPHuNO', NULL, 2, NULL, 10, NULL),
(12, 'dahana', '$2y$13$c3hfssChJfBaoZIxxOVJJO8GjruQfurOA5Xm56MCqVGi.iDe0dfAe', NULL, 2, NULL, 11, NULL),
(13, 'SALIM', '$2y$13$6aw/dM0QgGKpTV6h/EXemeJFNm3ms2omG5Ki5IJrFpOhPfRfOtEFC', NULL, 2, NULL, 12, NULL);
