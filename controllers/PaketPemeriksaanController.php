...
use app\models\PaketPemeriksaanSearch;
...
/**
 * PaketPemeriksaanController implements the CRUD actions for PaketPemeriksaan model.
 */
class PaketPemeriksaanController extends Controller
{
    ...
    /**
     * Lists all PaketPemeriksaan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PaketPemeriksaanSearch();
    ...
    /**
     * Displays a single PaketPemeriksaan model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PaketPemeriksaan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id_paket)
    {
        $model = new PaketPemeriksaan(['id_paket' => $id_paket]);
    ...
    /**
     * Updates an existing PaketPemeriksaan model.
    ...
    /**
     * Deletes an existing PaketPemeriksaan model.
    ...
    /**
     * Finds the PaketPemeriksaan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PaketPemeriksaan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PaketPemeriksaan::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id Paket');
        $sheet->setCellValue('C3', 'Id Pemeriksaan');

        $sheet->setCellValue('A1', 'Data PaketPemeriksaan');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_paket);
            $sheet->setCellValue('C' . $row, $data->id_pemeriksaan);
