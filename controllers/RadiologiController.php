...
use app\models\RadiologiSearch;
...
class RadiologiController extends Controller
{
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('D3', 'Cor');
        $sheet->setCellValue('E3', 'Pulmo');
        $sheet->setCellValue('F3', 'Sinus Diafragma');
        $sheet->setCellValue('G3', 'Tulang Jaringan Lunak');

        $sheet->setCellValue('A1', 'Data Radiologi');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('D' . $row, $data->cor);
            $sheet->setCellValue('E' . $row, $data->pulmo);
            $sheet->setCellValue('F' . $row, $data->sinus_diafragma);
            $sheet->setCellValue('G' . $row, $data->tulang_jaringan_lunak);
