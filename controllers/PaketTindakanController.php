...
use app\models\PaketTindakanSearch;
...
/**
 * PaketTindakanController implements the CRUD actions for PaketTindakan model.
 */
class PaketTindakanController extends Controller
{
    ...
    /**
     * Lists all PaketTindakan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PaketTindakanSearch();
    ...
    /**
     * Displays a single PaketTindakan model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PaketTindakan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id_paket)
    {
        $model = new PaketTindakan();
    ...
    /**
     * Updates an existing PaketTindakan model.
    ...
    /**
     * Deletes an existing PaketTindakan model.
    ...
    /**
     * Finds the PaketTindakan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PaketTindakan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PaketTindakan::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('C3', 'Id Tindakan');

        $sheet->setCellValue('A1', 'Data PaketTindakan');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('C' . $row, $data->id_tindakan);
