...
use app\models\DiagnosaKerjaSearch;
...
/**
 * DiagnosaKerjaController implements the CRUD actions for DiagnosaKerja model.
 */
class DiagnosaKerjaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all DiagnosaKerja models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DiagnosaKerjaSearch();
    ...
    /**
     * Displays a single DiagnosaKerja model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DiagnosaKerja model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new DiagnosaKerja();
    ...
    /**
     * Updates an existing DiagnosaKerja model.
    ...
    /**
     * Deletes an existing DiagnosaKerja model.
    ...
    /**
     * Finds the DiagnosaKerja model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DiagnosaKerja the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DiagnosaKerja::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('A1', 'Data DiagnosaKerja');
