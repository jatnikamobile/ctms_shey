...
class RegistrasiController extends Controller
{
    ...
    public function actionCreate($pasien_id = null)
    {
        ...
        $modelPasien = Pasien::findOne($pasien_id);
        $model->nik_pasien = @$modelPasien->nik;
        $model->nama_pasien = @$modelPasien->nama;
        $model->alamat_pasien = @$modelPasien->alamat;
        $model->tempat_lahir_pasien = @$modelPasien->tempat_lahir;
        $model->tanggal_lahir_pasien = @$modelPasien->tanggal_lahir;
        $model->jenis_kelamin_pasien = @$modelPasien->jenis_kelamin;
        $model->golongan_darah_pasien = @$modelPasien->golongan_darah;
        $model->no_telepon_pasien = @$modelPasien->no_telepon;
        $model->status_kawin_pasien = @$modelPasien->status_kawin;
        $model->id_pasien_agama = @$modelPasien->id_pasien_agama;
        $model->id_pasien_pekerjaan = @$modelPasien->id_pasien_pekerjaan;
        $model->id_pasien_pendidikan = @$modelPasien->id_pasien_pendidikan;
        $model->id_pasien_instansi = @$modelPasien->id_pasien_instansi;
        $model->id_pasien_unit = @$modelPasien->id_pasien_unit;
...
CSS;
    ...
    public function actionPdfFormulir($id) {
        // get your HTML raw content without any layouts or scripts
        // $content = $this->renderPartial('_reportPdfView');
        $model = \app\models\Registrasi::findOne($id);
        $content = $this->renderPartial('_formulirPdf', [
                     'model' => $model,
                     // etc...
                     ]);       
        $cssInline = <<<CSS
...
CSS;
        ...
        $pdf->filename = date('YmdHis') . "_Formulir_MCU.pdf";
        //print_r($pdf); die();
        // return the pdf output as per the destination setting
        return $pdf->render(); 
    }
