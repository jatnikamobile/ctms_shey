...
use app\models\KesimpulanSearch;
...
/**
 * KesimpulanController implements the CRUD actions for Kesimpulan model.
 */
class KesimpulanController extends Controller
{
    ...
    /**
     * Lists all Kesimpulan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KesimpulanSearch();
    ...
    /**
     * Displays a single Kesimpulan model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Kesimpulan model.
    ...
    /**
     * Updates an existing Kesimpulan model.
    ...
    /**
     * Deletes an existing Kesimpulan model.
    ...
    /**
     * Finds the Kesimpulan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Kesimpulan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Kesimpulan::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('C3', 'Id Diagnosa Kerja');
        $sheet->setCellValue('D3', 'Isi Kesimpulan');
        $sheet->setCellValue('E3', 'Saran');

        $sheet->setCellValue('A1', 'Data Kesimpulan');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('C' . $row, $data->id_diagnosa_kerja);
            $sheet->setCellValue('D' . $row, $data->isi_kesimpulan);
            $sheet->setCellValue('E' . $row, $data->saran);
...
CSS;*/
    ...
    public function actionPdf($id) {
        ...
        $model = \app\models\Kesimpulan::findOne($id);
        $content = $this->renderPartial('_reportKesimpulan', [
                     'model' => $model,
                     // etc...
                     ]);       
        ...
        $pdf->filename = date('YmdHis') . "_Kesimpulan_MCU.pdf";
