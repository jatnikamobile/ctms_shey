...
/* @var $searchModel app\models\PemeriksaanFisikMulutSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Fisik Mulut';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-fisik-mulut-index box box-primary">

    <div class="box-header">
        <?= Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Fisik Mulut', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
