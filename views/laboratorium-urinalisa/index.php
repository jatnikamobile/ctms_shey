...
/* @var $searchModel app\models\LaboratoriumUrinalisaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Laboratorium Urinalisa';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="laboratorium-urinalisa-index box box-primary">

    <div class="box-header">
        <?php // Html::a('<i class="fa fa-plus"></i> Tambah Laboratorium Urinalisa', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
