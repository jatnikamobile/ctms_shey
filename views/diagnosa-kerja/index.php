...
/* @var $searchModel app\models\DiagnosaKerjaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Diagnosa Kerja';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="diagnosa-kerja-index box box-primary">

    <div class="box-header">
        <?= Html::a('<i class="fa fa-plus"></i> Tambah Diagnosa Kerja', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
