...
/* @var $searchModel app\models\PemeriksaanFisikManuferEkstremitasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Fisik Manufer Ekstremitas';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-fisik-manufer-ekstremitas-index box box-primary">

    <div class="box-header">
        <?php // Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Fisik Manufer Ekstremitas', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
