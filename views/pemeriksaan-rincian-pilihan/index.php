...
/* @var $searchModel app\models\PemeriksaanRincianPilihanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Rincian Pilihan';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-rincian-pilihan-index box box-primary">

    <div class="box-header">
        <?= Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Rincian Pilihan', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
