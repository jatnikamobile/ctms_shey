...
$this->title = 'Daftar Pendidikan';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pendidikan-index box box-primary">

    <div class="box-header">
        <?= Html::a('<i class="fa fa-plus"></i> Tambah Pendidikan', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
