...
/* @var $searchModel app\models\PaketPemeriksaanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Protokol Uji';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="paket-pemeriksaan-index box box-primary">

    <div class="box-header">
        <?= Html::a('<i class="fa fa-plus"></i> Tambah Protokol Uji', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
