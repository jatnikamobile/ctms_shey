...
/* @var $searchModel app\models\PemeriksaanFisikThoraxSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Fisik Thorax';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-fisik-thorax-index box box-primary">

    <div class="box-header">
        <?php // Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Fisik Thorax', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
