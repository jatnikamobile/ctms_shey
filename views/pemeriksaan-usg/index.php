...
/* @var $searchModel app\models\PemeriksaanUsgSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Usg';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-usg-index box box-primary">

    <div class="box-header">
        <?php // Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Usg', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label'=>'Download Pemeriksaan USG',
                'encodeLabel' => false,
                'format' => 'raw',
                'value' => function($data){
                    return Html::a("<i class='fa fa-download'><i>",['pemeriksaan-usg/pdf','id'=>$data->id]);
                },
                'headerOptions' => ['style' => 'text-align:center;'],
