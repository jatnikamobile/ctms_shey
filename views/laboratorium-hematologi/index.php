...
/* @var $searchModel app\models\LaboratoriumHematologiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Laboratorium Hematologi';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="laboratorium-hematologi-index box box-primary">

    <div class="box-header">
        <?php // Html::a('<i class="fa fa-plus"></i> Tambah Laboratorium Hematologi', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
