...
/* @var $searchModel app\models\PemeriksaanFisikMataSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pemeriksaan Fisik Mata';
$this->params['breadcrumbs'][] = $this->title;
?>
        <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

<div class="pemeriksaan-fisik-mata-index box box-primary">

    <div class="box-header">
        <?php  // Html::a('<i class="fa fa-plus"></i> Tambah Pemeriksaan Fisik Mata', ['create'], ['class' => 'btn btn-success btn-flat']) ?>
...
<?= $this->render('_grafik',['searchModel' => $searchModel]) ?>